...
BSDFData ConvertSurfaceDataToBSDFData(uint2 positionSS, SurfaceData surfaceData)
{
    ...
    if (HasFlag(surfaceData.materialFeatures, MATERIALFEATUREFLAGS_WATER_SUBSURFACE_SCATTERING))
    {
...
void ModifyBakedDiffuseLighting(float3 V, PositionInputs posInput, SurfaceData surfaceData, inout BuiltinData builtinData)
{
    ...
    if (HasFlag(bsdfData.materialFeatures, MATERIALFEATUREFLAGS_WATER_SUBSURFACE_SCATTERING))
    {
...
{
    // There are multiple transparent layers occuring near the surface of the human water,
